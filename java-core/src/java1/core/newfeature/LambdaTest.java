...
public class LambdaTest {
    ...
    public static void main(String[] args){
        ...
        /// LambdaTest.testStream();

        /// LambdaTest.filterTest(students);

        /// LambdaTest.distinctTest(nums);

        /// LambdaTest.limitTest(students);

        /// LambdaTest.sortedTest(students);

        /// LambdaTest.skipTest(students);

        /// LambdaTest.mapTest(students);

        /// LambdaTest.flatMapTest(students);

        /// LambdaTest.allMatchTest(students);

        /// LambdaTest.anyMatchTest(students);

        /// LambdaTest.noneMatchTest(students);

        /// LambdaTest.findFirstTest(students);

        /// LambdaTest.findAnyTest(students);

        /// LambdaTest.reduceTest(students);

        /// LambdaTest.collectTest(students);

        /// LambdaTest.groupTest(students);

        LambdaTest.partTest(students);
    }
